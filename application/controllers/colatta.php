...
class colatta extends CI_Controller {
	...
	{
        parent::__construct();
        $this->data['controller'] = $this->uri->segment("colatta");
		$this->data['pageTitle'] = "Colatta";
		$this->load->model('colatta_mod');
	}
	...
	public function index()
	{
		...
		$data['content']    = $this->load->view('colatta',$vdata,TRUE);
		$data['title']      = "Colatta";
	...
	function get_colatta(){
		...
		$data 	= $this->colatta_mod->get_data();
