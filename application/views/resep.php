...
<script type="text/javascript" src="<?php echo base_url() ?>js/js_form/resep.js"></script>
<body>
<?php
...
<div class="portlet-body form">
    <div class="row">
        ...
        <div class="col-md-9">
            <h1><span class="caption-subject font-red-sunglo bold uppercase">RESEP IDEAS</span></h1>
                <table class="table" id="prod_resep" border=0>
                    <thead>
                        <tr align="center" valign="middle">		
                            <th colspan="4" class="hide"></th>
                        ...
                        <tr>
                            ...
                            <?php
                            if($username=='admin'){
                                echo'<th width="30%" class="hide"></th>';
                            }
                            ?>
                        </tr>
                    </thead>
...
<div id="modal_resep" class="modal fade bs-modal-lg" tabindex="-1" aria-hidden="true">
            ...
            <div class="portlet-body form">
                ...
                <input type="hidden" id="hid_id" name="hid_id"/>
                    ...
                    <div class="form-group tight-bottom">
                        ...
                        <div class="col-md-9">	
                        <input type="text" class="form-control input-sm" placeholder="Judul" id="title" name="title"/>
                        </div>
                    </div>
                    <div class="form-group tight-bottom">
                        <label class="col-md-3 control-label">Cara Pembuatan </label>
                        <div class="col-sm-9">
                        <textarea class="form-control input-sm" rows="10" placeholder="Cara Pembuatan" name="cara" id="cara" ></textarea>
                        </div>
                    </div>
