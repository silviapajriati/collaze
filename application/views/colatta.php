...
<script type="text/javascript" src="<?php echo base_url() ?>js/js_form/colatta.js"></script>
<body>
<?php
...
<div class="portlet-body form">
    <div class="row">
        ...
        <div class="col-md-9">
            <h1><span class="caption-subject font-red-sunglo bold uppercase">COLATTA SERIES</span></h1>
                <table class="table" id="prod_colatta" border=0>
                    <thead>
...
<div id="modal_colatta" class="modal fade bs-modal-lg" tabindex="-1" aria-hidden="true">
